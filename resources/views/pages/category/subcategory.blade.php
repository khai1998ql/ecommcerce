...
//                                    dd($product_detail);
                        ...
                        <div class="left-title mb-20">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    Từ 0-{{ formatPrice(200000) }}
                                    <span class="badge badge-primary badge-pill">14</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    Từ {{ formatPrice(200000) }}-{{ formatPrice(500000) }}
                                    <span class="badge badge-primary badge-pill">2</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    Từ {{ formatPrice(500000) }} trở lên
...
{{--                    </div>--}}
                    <div class="toolbar mb-30">
                        ...
                        <form action="{{ route('subcateogry.ordeby') }}" method="POST">
                            @csrf
                            <div class="toolbar-sorter">
                                <span>Sắp xếp</span>
                                <select id="sorter" name="orderby" class="sorter-options" data-role="sorter">
                                    <option selected="selected" value="ASC"> Giá từ thấp lên cao </option>
                                    <option value="DESC"> Giá từ cao xuống thấp </option>
                                    <option value="">Theo danh sách</option>
                                </select>
